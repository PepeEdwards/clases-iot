...
<div class="grid grid-cols-4 gap-4 mt-4">
  ...
  **Situación:** Tengo una estufa y me gustaría que se prenda y apague sola.
  ...
  <div class="p-4 rounded border border-white/20 bg-white/5">
    <img src="./images/Pie-de-metro-digital.png" class="h-25 object-contain mx-auto mt-1" />
  </div>
  <div class="p-4 rounded border border-white/20 bg-white/5">
    <img src="./images/Unidad de control de motor.jpg" class="h-25 object-contain mx-auto mt-1" />
  </div>
  <div class="p-4 rounded border border-white/20 bg-white/5">
    <img src="./images/horno_digital.png" class="h-25 object-contain mx-auto mt-1" />
  </div>
  <div class="p-4 rounded border border-white/20 bg-white/5">
    <img src="./images/termometrodigital.jpg" class="h-25 object-contain mx-auto mt-1" />
  </div>
...
<div class="p2">
<img src="./images/Apolo_Guidance_computer.png" class="h-40 object-contain mx-auto mt-1" />
</div>

<div class="p2">

<img src="./images/Intel_C4004.jpg" class="h-40 object-contain mx-auto mt-1" />
</div>

<div class="p2">
<img src="./images/Sintonizador de radio aereo.jpg" class="h-40 object-contain mx-auto mt-1" />
</div>
...
<img src="./images/Robot Hobby talleres Microcontrolador 1_.png" class="h-30 object-contain mx-auto mt-1" />
<div class="text-sm mt-1">Robots, juegos, proyectos creativos de taller</div>
</div>

<div v-click class="p-3 rounded-lg border border-white/20 bg-white/5">
<div class="font-bold text-sm mb-1">🎓 Educación</div>
<img src="./images/Microbit education microcontroller.png" class="h-30 object-contain mx-auto mt-1" />
<div class="text-sm mt-1">Micro:bit, kits escolares, aprendizaje visual</div>
</div>

<div v-click class="p-3 rounded-lg border border-white/20 bg-white/5">
<div class="font-bold text-sm mb-1">🌡️ Control</div>
<img src="./images/Generadores helocos ejemplo control.png" class="h-30 object-contain mx-auto mt-1" />
...
<img src="./images/Mechanical Keyboard Example Product.jpg" class="h-30 object-contain mx-auto mt-1" />
...
<img src="./images/Raspberry Pi Model B 2012.png" class="h-20 object-contain mx-auto mb-2" />
<strong>Raspberry Pi</strong>
<div class="text-xs opacity-60">La original. Mayor comunidad.</div>
</div>

<div v-click class="text-center p-3 rounded border border-white/20 bg-white/5">
<img src="./images/Banana Pi.png" class="h-20 object-contain mx-auto mb-2" />
<strong>Banana Pi</strong>
<div class="text-xs opacity-60">Compatible con ecosistema RPi</div>
</div>

<div v-click class="text-center p-3 rounded border border-white/20 bg-white/5">
<img src="./images/orange-pi-cm5.jpg" class="h-20 object-contain mx-auto mb-2" />
<strong>Orange Pi</strong>
<div class="text-xs opacity-60">Rockchip, muy costo-eficiente</div>
</div>

<div v-click class="text-center p-3 rounded border border-white/20 bg-white/5">
<img src="./images/raxda board.png" class="h-20 object-contain mx-auto mb-2" />
<strong>Radxa / Rock Pi</strong>
<div class="text-xs opacity-60">Rockchip, NVMe, M.2</div>
</div>

<div v-click class="text-center p-3 rounded border border-white/20 bg-white/5">
<img src="./images/jetson-nano-board.jpg" class="h-20 object-contain mx-auto mb-2" />
<strong>NVIDIA Jetson</strong>
<div class="text-xs opacity-60">GPU integrada para ML/IA</div>
</div>

<div v-click class="text-center p-3 rounded border border-white/20 bg-white/5">
<img src="./images/Arduino uno Q SBC.png" class="h-20 object-contain mx-auto mb-2" />
...
<div class="p-3 rounded-lg border border-white/20 bg-white/5 text-center">
  <img src="./images/arduino ide logo.png" class="h-14 object-contain mx-auto mb-2" />
...
<div class="p-3 rounded-lg border border-white/20 bg-white/5 text-center">
  <img src="./images/micropython logo.png" class="h-14 object-contain mx-auto mb-2" />
...
<div class="p-3 rounded-lg border border-white/20 bg-white/5 text-center">
  <img src="./images/esp-idf logo.png" class="h-14 object-contain mx-auto mb-2" />
...
<img src="./images/question_cat.jpg" class="h-40 object-contain mx-auto mt-4" />
